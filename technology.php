...
<body>
	<div name="home" id="home">
		<h1>Tecnologias</h1>
		<div class="itemTec"><img src="images/logos/HTML5.png" style="float: left; height: 100px; margin-right: 5px;"><p style="vertical-align: middle;">As linguagens HTML e XHTML vem se atualizando para o novo mundo de dispositivos portateis
		e interatividade na web. O HTML 5 transforma um site em um verdadeiro centro de entretenimento 
		...
		e é muito flexivel, podendo ainda ser usado algum framework como Zend Framework para agilizar no processo de desenvolvimento do site ou sistema web.</p></div>
		<div class="itemTec"><img src="images/logos/RubyOnRails.png" style="float: left; height: 100px; margin-right: 5px;"><p style="vertical-align: middle;">É um framework escrito para Ruby que aumenta a velocidade de desenvolvimento de aplicações web que utilizam orientação para banco de dados. Esse framework 
		utiliza tecnologias atuais e rápidas que tornam tanto o desenvolvimento quanto o resultado final excelentes. Utilizando o padrão MVC para construir a estrutura de sites tornando uma possível manutenção de codigo rápida e eficaz.</p></div>
		<div class="itemTec"><img src="images/logos/JAVA.png" style="float: left; height: 100px; margin-right: 5px;"><p style="vertical-align: middle;">É uma linguagem que já domina o mercado empresarial de aplicativos. É ampla e possui diversas bibliotecas prontas, inclusive bibliotecas que 
		auxiliam na troca de dados através de redes e internet. É orinetada a objetos e muito segura. Uma ótima escolha para quem precisa de um aplicativo desktop
		como um sistema de gestão, por exemplo.</p></div>
